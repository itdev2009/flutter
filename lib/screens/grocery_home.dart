...
import 'mapCurrentAddressPicker.dart';

class GroceryHome extends StatefulWidget {
  // 18001025963
  final int _categodyId;

  GroceryHome(this._categodyId);

  @override
  _GroceryHomeState createState() => _GroceryHomeState(_categodyId);
}

class _GroceryHomeState extends State<GroceryHome> {
  final int _categodyId;

  _GroceryHomeState(this._categodyId);
  ...
  Future<RestaurantsListModel> _groceryListApi;
      ...
      child: Scaffold(
          ...
          body: ListView(
            ...
            children: [
              ...
              //             child: ListView.builder(
              //                 shrinkWrap: true,
              //                 itemCount: snapshot.data.data[1].subcategory.length,
              //                 scrollDirection: Axis.horizontal,
              //                 itemBuilder: (context, index) {
              //                   return InkWell(
              //                     onTap: (){
              ...
              //                       width: 145,
              //                       clipBehavior: Clip.hardEdge,
              //                       decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(15.0)), color: Colors.red),
              //                       child: Stack(
              //                         children: [
              //                           FadeInImage(
              //                             height: 150.0,
              //                             width: 145.0,
              //                             image: NetworkImage(
              //                               "$imageBaseURL${snapshot.data.data[1].subcategory[index].categoryImage}",
              //                             ),
              //                             placeholder: AssetImage(
              //                                 "assets/images/placeHolder/rectangle.png"),
              //                             fit: BoxFit.fill,
              //                           ),
              //                           Positioned(
              //                             bottom: 20,
              //                             child: Container(
              //                               width: 150,
              //                               child: Center(child: Text("${snapshot.data.data[1].subcategory[index].subcategoryname}",
              ...
              Container(
                  ...
                  child: Text(
                    "Popular Grocery Shops".toUpperCase(),
                    style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 14.0),
                  )),
                  ...
                  if (snapshot.hasData) {
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          vegShopIndex=(index-((index/vegShopPlaceHolder.length).floor()*vegShopPlaceHolder.length));
                                        ...
                                        Expanded(
                                            ...
                                            child: Container(
                                              ...
                                              child: FadeInImage(
                                                ...
                                                placeholder: AssetImage("assets/images/placeHolder/veg/${vegShopPlaceHolder[vegShopIndex]}"),
                                                fit: BoxFit.fill,
                                              ),
                                            )),
                                        Expanded(
...
//                         Navigator.push(
//                             context,
//                             MaterialPageRoute(builder: (context) => MapHomePage1(pageIndex: 2,)
//                               // AddressPage()
//                             ));
//                       },
//                       child: Column(
...
//     margin: EdgeInsets.fromLTRB(15, 15, 10, 10),
//     child: Text(
//       "Grocery Shops Near You".toUpperCase(),
//       style: TextStyle(
//           fontWeight: FontWeight.bold,
//           color: Colors.white,
//           fontSize: 14.0),
...
//                             // snapshot.data.data[index].vendorId, snapshot.data.data[index].shopName
//                         )));
//               },
//               child: Container(
//                   margin: EdgeInsets.all(7.0),
...
//                             child: FadeInImage(
//                               image: NetworkImage("$imageBaseURL${snapshot.data.data[index].vendorImage}"),
//                               placeholder: AssetImage("assets/images/grocery/grocery1.jpg"),
//                               fit: BoxFit.fill,
//                             ),
//                           )),
//                       Expanded(
...
//                           // color: Colors.redAccent,
//                           width: screenWidth * 0.58,
//                           margin: EdgeInsets.only(left: 15.0, top: 7.0, right: 10.0),
//                           child: Column(
//                             crossAxisAlignment: CrossAxisAlignment.start,
//                             children: [
//                               Text("${snapshot.data.data[index].shopName}",
//                                   style: TextStyle(
//                                       fontWeight: FontWeight.bold, color: Colors.black, fontSize: screenWidth * 0.04)),
//                               Container(
