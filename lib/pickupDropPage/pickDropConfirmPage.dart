...
class PickDropConfirmPage extends StatefulWidget {
  @override
  _PickDropConfirmPageState createState() => _PickDropConfirmPageState();
}

class _PickDropConfirmPageState extends State<PickDropConfirmPage> {
  ...
  void initState() {
    ...
    /*
    destinationLandmarkList.clear();
    destinationAddressList.clear();
    dropLatList.clear();
    droplongList.clear();
    rNameList.clear();
    rPhoneList.clear();
    receiverdestinationTextControllerList.clear();
    receivernameControllerList.clear();
    receiverphoneControllerList.clear();
                ...
                children: [
                  Center(
                    child: Padding(
                      ...
                      child: Image.asset(
                        "assets/images/icons/pickup_icons/pickup.png",
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "We have received your pickup order",
